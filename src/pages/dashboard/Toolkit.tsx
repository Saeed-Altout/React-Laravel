...
export default function Toolkit() {
  ...
  const { data } = useFetch({ endpoint: "tool/index" });
  ...
  return (
    <div className="flex-1 space-y-5">
      <CreateModal
        endpoint="tool"
        messageError="Failed added toolkit!"
        messageSuccess="Toolkit added"
        isOpen={isOpen}
...
const columns: ColumnDef<ToolkitColumn>[] = [
  {
    accessorKey: "name",
    header: "Name",
  },
  ...
  },
  {
    id: "actions",
    cell: ({ row }) => (
      <CellAction initialData={row.original} endpoint="tool" />
    ),
  },
];
